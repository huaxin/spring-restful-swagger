package me.lianghuaxin.example;
...
@Slf4j
public class UserServiceTest extends SpringRestfulSwaggerApplicationTests {
    @Autowired
    ...
    public void testSave() {
        ...
        User testSave3 = User.builder().name("testSave31").password(SecureUtil.md5("123456" + salt)).salt(salt).email("testSave31@xkcoding.com").phoneNumber("173000000031").status(1).lastLoginTime(new DateTime()).build();
